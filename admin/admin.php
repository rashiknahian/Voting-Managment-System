  ...
  <section id="testimonials" class="hoc container clear"> 
    ...
    <ul class="nospace group">
       ...
       <li class="one_half">
         ...
         <blockquote>Welcome to "Voting Managment System" <br>Electronic voting (also known as e-voting) refers to voting using electronic means to either aid or take care of the chores of casting and counting votes.
